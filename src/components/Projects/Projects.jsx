...
function Projects() {
  ...
  function openSorting() {
    window.location.replace("https://sortvisu.netlify.app/");
  }
  ...
  return (
    <div className="projects-container" id="Projects">
      ...
      <div onClick={openSorting} className="flip-card">
        <div className="flip-card-inner">
          <div className="flip-card-front">
            <img className="proje-img" alt="proje-img" src={sorting} />
          </div>
          <div className="flip-card-back">
            <h1>Sorting</h1>
            <p>It's a basic react app</p>
            <p>This one I try to visualize bubble sorting algorithm</p>
          </div>
        </div>
      </div>
